...
def prepare_data(
    ...
    train_ds = monai.data.CacheDataset(data=train_files, transform=train_transforms, cache_rate=cache_rate, num_workers=num_workers)

    from monai.data.utils import pad_list_data_collate
    return DataLoader(train_ds, num_workers=0, batch_size=batch_size, shuffle=True, collate_fn=pad_list_data_collate)
